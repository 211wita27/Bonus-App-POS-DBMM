...
VALUES ((SELECT id FROM restaurant WHERE code = 'DEMO'), 'Standard Multiplikator', '1 Punkt pro Euro', 'MULTIPLIER', 1.00, 1.00, 0, DATE '2024-01-01', NULL, TRUE);

INSERT INTO reward (restaurant_id, reward_code, name, description, reward_type, cost_points, valid_from, valid_until, active)
VALUES ((SELECT id FROM restaurant WHERE code = 'DEMO'), 'WELCOME-DRINK', 'Welcome Drink', 'Kostenloses Getraenk', 'PRODUCT', 50, CURRENT_DATE, NULL, TRUE);
